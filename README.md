# GI Tweaks
For a detailed overview of the features provided, [click here](#current-features).
...
1. Download the [latest release](https://github.com/pema99/GITweaks/releases) zip.
